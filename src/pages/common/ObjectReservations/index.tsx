...
function Main() {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter(cell) {
                            const response: Response = cell.getData();
                            return `<div>
                                        <div class="font-medium whitespace-nowrap">${response.client_name}</div>
                                    </div>`;
                        },
                    },
                    {
    ...
    useEffect(() => {
        ...
        dispatch(fetchReservationsByObject(Number(params.id!)));
        dispatch(fetchObjectById(Number(params.id!)));
    }, []);
    ...
    useEffect(() => {
        if (reservations.length) {
            const formattedData = reservations.map((reservation) => ({
                id: reservation.id,
                client_name: reservation.client.fullname,
